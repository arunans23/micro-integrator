...
public class ErrorLogReader {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ErrorLogReader.class);
    private CarbonLogTailer errorLogTailer;
    ...
    public void start() {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Starting to tail error logs from : " + carbonLogFile.getPath());
        }
        tailer = new Tailer(carbonLogFile, errorLogTailer, 1, startReadingFromEndOfFile);
    ...
    public String getLogs() {
        return errorLogTailer.getCarbonLogs();
    }
